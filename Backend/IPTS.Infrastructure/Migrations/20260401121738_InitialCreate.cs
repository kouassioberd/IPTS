        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedInsuranceTypes = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "HospitalPerformanceStats",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    HospitalId = table.Column<Guid>(type: "uuid", nullable: false),
                    TotalTransfersHandled = table.Column<int>(type: "integer", nullable: false),
                    TotalRequestsReceived = table.Column<int>(type: "integer", nullable: false),
                    TotalAccepted = table.Column<int>(type: "integer", nullable: false),
                    TotalDeclined = table.Column<int>(type: "integer", nullable: false),
                    AvgResponseTimeMinutes = table.Column<double>(type: "double precision", nullable: false),
                    AvgTransferDurationMinutes = table.Column<double>(type: "double precision", nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HospitalPerformanceStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HospitalPerformanceStats_Hospitals_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "Hospitals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmbulanceCrews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AmbulanceCrews_Ambulances_AmbulanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmbulanceCrews_AmbulanceId",
                table: "AmbulanceCrews",
                column: "AmbulanceId");

            migrationBuilder.CreateIndex(
                name: "IX_AmbulanceCrews_Email",
                table: "AmbulanceCrews",
                column: "Email",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalPerformanceStats_HospitalId",
                table: "HospitalPerformanceStats",
                column: "HospitalId");
